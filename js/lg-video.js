...
(function (root, factory) {
    ...
    (function () {
        ...
        Video.prototype.loadVideo = function (src, addClass, noPoster, index, html) {
            ...
            } else if (isVideo.bilibili) {

                a = '&autoplay=' + autoplay;
                video = '<iframe class="lg-video-object ' + addClass + '" ' + videoTitle + ' width="560" height="315"  src="//player.bilibili.com/player.html?bvid=' + isVideo.bilibili[1] + a + '" frameborder="0" framespacing="0" webkitAllowFullScreen allowFullScreen></iframe>';
